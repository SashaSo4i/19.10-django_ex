...
valid_tests = (
    (
        models.check_created,
        datetime(config.PAST_YEAR, 1, 1, 1, 1, 1, 1, tzinfo=timezone.utc),
    ),
    (
        models.check_modified,
        datetime(config.PAST_YEAR, 1, 1, 1, 1, 1, 1, tzinfo=timezone.utc),
    ),
...
invalid_tests = (
    (
        models.check_created,
        datetime(config.NEVER_YEAR, 1, 1, 1, 1, 1, 1, tzinfo=timezone.utc),
    ),
    (
        models.check_modified,
        datetime(config.NEVER_YEAR, 1, 1, 1, 1, 1, 1, tzinfo=timezone.utc),
