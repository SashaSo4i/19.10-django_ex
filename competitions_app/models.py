...
class Stage(UUIDMixin, NameMixin, CreatedMixin, ModifiedMixin):
    ...
    def clean(self) -> None:
        ...
        Raises:
            ValidationError: if stage holds before competition.
            ValidationError: if stage holds after competition.

        Returns:
            valid: is valid data.
        """
        # Checking that comp_sport is filled
        ...
        # Calling the parent clean method
        return super().clean()
